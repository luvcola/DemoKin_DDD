...
The output of `DemoKin::kin` includes information on the age of relatives in the the columns `kin_summary$mean_age` and `kin_summary$$sd_age`. For example, this allows us to determine the age of Focal's cousins over the lifecourse of Focal? 
